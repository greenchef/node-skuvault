...
exports.ApiException = exports.SkuVault = exports.SV = undefined;
...
var SkuVault = (_class = function () {
  ...
  */
		...
		value: function value(path, method, params, cb) {
			...
			return (0, _requestPromise2.default)(requestOptions).then(function (result) {
				cb(result);
