  ...
  */
	...
	(0, _createClass3.default)(Products, [{
		...
		value: function find() {
			...
			return (_skuvault = this.skuvault).api.apply(_skuvault, ['/products/getProducts', 'post'].concat(args)).then(function (response) {
   ...
   */
		...
		value: function create() {
			...
			var endpoint = '/products/createProduct';
   ...
   */
		...
		value: function update() {
			...
			var endpoint = '/products/updateProduct';
			...
			return (_skuvault3 = this.skuvault).api.apply(_skuvault3, [endpoint, 'post'].concat(args));
		}
