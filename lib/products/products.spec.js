...
(0, _mocha.beforeEach)(function () {
	(0, _nock2.default)(_config2.default.apiUrl).post('/products/getProducts', {}).reply(200, function () {
		return {
...
(0, _mocha.describe)('Products.create({Sku: \'G-OMN-08-00034-Y\'})', function () {
	(0, _mocha.before)(function () {
		(0, _nock2.default)(_config2.default.apiUrl).post('/products/createProduct', {}).reply(400, function () {
...
(0, _mocha.describe)('Products.create({Sku: \'G-OMN-08-00034-Y\'})', function () {
	(0, _mocha.before)(function () {
		(0, _nock2.default)(_config2.default.apiUrl).post('/products/createProduct', {}).reply(429, function () {
			return "429 - {\"Status\":\"Too many requests\",\"Errors\":[]}";
		});
	});
	(0, _mocha.it)('should fail with too many requests', function (done) {
		sv.products.create({ Sku: 'G-OMN-08-00034-Y' }).catch(function (error) {
			(0, _chai.expect)(error.response).to.have.property('statusCode', 429);
			done();
		});
	});
});