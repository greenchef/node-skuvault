...
(0, _mocha.beforeEach)(function () {
	(0, _nock2.default)(_config2.default.apiUrl).post('/products/getBrands', {}).reply(200, function () {
		return {
...
(0, _mocha.describe)('Brands.create({Name: \'Lincoln\'})', function () {
	(0, _mocha.before)(function () {
		(0, _nock2.default)(_config2.default.apiUrl).post('/products/createBrands', {}).reply(400, function () {
