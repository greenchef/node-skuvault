...
var Suppliers = (_class = function () {
	function Suppliers(skuvault) {
		(0, _classCallCheck3.default)(this, Suppliers);
  ...
  */
	...
	(0, _createClass3.default)(Suppliers, [{
		key: 'find',
		value: function find() {
			var _skuvault,
			    _this = this;
			...
			return (_skuvault = this.skuvault).api.apply(_skuvault, ['/products/getSuppliers', 'post'].concat(args)).then(function (response) {
   ...
   */
		...
		value: function create() {
			...
			return (_skuvault2 = this.skuvault).api.apply(_skuvault2, ['/products/createSuppliers', 'post'].concat(args));
		}
