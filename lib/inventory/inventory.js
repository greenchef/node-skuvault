  ...
  */
	...
	(0, _createClass3.default)(Inventory, [{
		...
		value: function find() {
			...
			return (_skuvault = this.skuvault).api.apply(_skuvault, ['/inventory/getItemQuantities', 'post'].concat(args));
		}
   ...
   */
		...
		value: function add() {
			...
			var endpoint = '/inventory/addItem';
   ...
   */
		...
		value: function remove() {
			...
			var endpoint = '/inventory/removeItem';
